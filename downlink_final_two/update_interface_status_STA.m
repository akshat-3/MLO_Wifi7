function [interface, sta_to_tx_interface] = update_interface_status_STA(interface, num_samples, sample_no, sta_to_tx_interface, rssi, occupancy_matrix, is_channel_bonding, occupancy_at_access)
    ...
    switch sta_to_tx_interface.state
        ...
        case STATE_IDLE
            ...
            if sta_to_tx_interface.packets_received > 0 %for this transmission
                    ...
                    sta_to_tx_interface.state = STATE_TX;
                        ...
                        %can this be optimised?
                            ...
                            if isempty(sta_to_tx_interface.packet_level_details(1).time_tx1)
                                ...
                                sta_to_tx_interface.packet_level_details(1).time_tx2 = sample_no;
                                sta_to_tx_interface.packet_level_details(1).n_tx_attempts = sta_to_tx_interface.packet_level_details(1).n_tx_attempts + 1;
                            end
