function [ap, sta] = update_ap_status_async_static(ap, num_samples, s, sta, rssi, occupancy_matrix)
 
    %AP MLO, STA SLO+MLO. 5 SLO on 5th sub-channel, 3 SLO on 3rd sub-channel.
    %Static flow allocation
        ...
        case STATE_BO
            ...
            if ~sample_busy % Idle sample
                if ap.interface_one.bo < ap.interface_one.s_BO
                    ...
                    [packets_to_tx, ap, ap.interface_one] = get_packets_to_tx(ap, ap.interface_one, search_space_lmac);
        ...
        case STATE_SIFS
            ...
            if ap.interface_one.sifs < (s_SIFS+s_BACK)
                ...
                if ap.interface_one.sifs == s_SIFS && ap.interface_one.is_collision == true
                    %unsuccessful tx
                    current_tx_sta = ap.interface_one.q(1,1);
                    ...
                    if ap.interface_one.n_tx_attempts == n_MAX_TX_ATTEMPTS
                        ...
                        sta(current_tx_sta).interface_one.n_packet_drop = sta(current_tx_sta).interface_one.n_packet_drop +  ap.interface_one.n_agg;
                        ...
                        for i = 1:search_space_lmac
                            ...
                            if ap.interface_one.q(k, 1) == current_tx_sta
                                packets_to_remove = packets_to_remove - 1;
                                ap.interface_one.q(ap.interface_one.q(k,1) == current_tx_sta, :) = [];
                                ap.interface_one.len_q = ap.interface_one.len_q - 1;
                            else
                                k = k + 1;
                            end
