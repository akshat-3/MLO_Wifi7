function [ap, sta] = update_ap_status_async_dynamic_interface_one(ap, num_samples, s, sta)
            ...
            if ap.interface_one.sifs < (s_SIFS+s_BACK)
                ...
                if ap.interface_one.sifs == s_SIFS && ap.interface_one.is_collision == true
                    ...
                    if ap.interface_one.n_tx_attempts == n_MAX_TX_ATTEMPTS
                        ...
                        ap.interface_one.n_packet_drop = ap_interface_one.n_packet_drop + ap_interface_one.n_agg;
                        sta(current_tx_sta).interface_one.n_packet_drop = sta(current_tx_sta).interface_one.n_packet_drop +  ap_interface_one.n_agg;
