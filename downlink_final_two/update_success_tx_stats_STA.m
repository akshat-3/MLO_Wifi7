function  [ap_interface, current_tx_sta_interface ] = update_success_tx_stats_STA(ap_interface, current_tx_sta_interface, L_D, sample_no)
    ...
    ap_interface.not_ACKED = ap_interface.not_ACKED - current_tx_sta_interface.n_agg*2;
    ...
    current_tx_sta_interface.num_data_bits_received = current_tx_sta_interface.num_data_bits_received + current_tx_sta_interface.n_agg*L_D;
